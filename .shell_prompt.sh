...
function __promptline {
  ...
  local c_bg="${wrap}48;5;254${end_wrap}"
  local c_sep_fg="${wrap}38;5;254${end_wrap}"
  ...
  local x_bg="${wrap}48;5;254${end_wrap}"
  local x_sep_fg="${wrap}38;5;254${end_wrap}"
  local y_fg="${wrap}38;5;238${end_wrap}"
  local y_bg="${wrap}48;5;252${end_wrap}"
  local y_sep_fg="${wrap}38;5;252${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
